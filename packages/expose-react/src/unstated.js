...
import { createContext as createReactContext } from 'preact-context'
...
var Subscribe = (function(_React$Component) {
  ...
  Subscribe.prototype.render = function render() {
    ...
    return h(StateContext.Consumer, null, function(map) {
      return _this6.props.children[0].apply(
        null,
...
function Provider(props) {
  return h(StateContext.Consumer, null, function(parentMap) {
    ...
    return h(StateContext.Provider, { value: childMap }, props.children)
  })
}
